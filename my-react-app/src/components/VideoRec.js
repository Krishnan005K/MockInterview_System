...
import './VideoRec.css';  // Import the CSS file for styling
import record from '../assets/images/record.jpg';
import end from '../assets/images/stop.jpg';
        ...
        <div className="video-rec-container">
            ...
            {!recordingCompleted ? (
                <>
                    ...
                    <div>
                        {!recording ? (
                            <button onClick={startRecording} style={{ border: "none" }}>Start</button>
                        ) : (
                            <button onClick={stopRecording} style={{ border: "none" }}>Stop</button>
                        )}
                    </div>
                    {currentQuestion && (
